...
using ElasticSearch.API.Interface;
...
namespace ElasticSearch.API.Controllers
{
    ...
    [ApiController]
    public class ElasticServiceController : ControllerBase
    {
        private IElasticSearchService _elasticsearchService;
        public ElasticServiceController(IElasticSearchService elasticsearchService)
        {
